...
const Footer = () => {
  return (
    <div className='bg-[#1F1F1F] md:pt-[146px] pt-[70px] md:pb-[146px] pb-[70px] '>
        <div className='max-w-6xl mx-auto md:flex'>

                    {/* ********* FOOTER LOGO AND ADDRESSING PART  ****** */}

            <div className='md:w-1/3 mb-[35px] p-[20px]'>
                <div><img src="./images/footerlogo.png" alt="footerlogo" /></div>    
                            
                <div className='text-white  gap-y-[30px] mt-[30px]	'>
                        <div className='flex gap-[8px] pb-[10px]'>                  
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M11.875 15H2.5L2.49812 5.56625L9.64437 10.5138C9.74887 10.5861 9.87293 10.6248 10 
                                10.6248C10.1271 10.6248 10.2511 10.5861 10.3556 10.5138L17.5 5.56875V11.25H18.75V5C18.7495 
                                4.66863 18.6176 4.35098 18.3833 4.11666C18.149 3.88235 17.8314 3.7505 17.5 3.75H2.5C2.16858 
                                3.75033 1.85083 3.88213 1.61648 4.11648C1.38213 4.35083 1.25033 4.66858 1.25 5V15C1.2505 
                                15.3314 1.38235 15.649 1.61666 15.8833C1.85098 16.1176 2.16863 16.2495 2.5 16.25H11.875V15ZM16.1244 
                                5L10 9.24L3.87563 5H16.1244Z" fill="white"/>
                                ...
                                <p className='font-pops text-xs '>mail@yourcompany.com</p>                  
                        </div>
                        <div className='flex gap-[8px] pb-[10px]'>
                                ...
                                <p className='font-pops text-xs '> +896 120 5889 (Toll free) </p>  
                        </div>
                        <div className='flex gap-[8px]'>
                                ...
                                {/* **** FOOTER SOCIAL ICON ** */}                
                            <div className='w-1/4 text-white flex gap-x-[10px] justify-start mt-8 pl-[10px]' >          
                        ...
                        {/* *********** FOOTER MENU ITEM  ************ */}
            <div className='md:w-2/3 flex md:justify-around flex-wrap md:flex-nowrap	 p-[30px]'> 
                <div className='font-pops text-white flex flex-col gap-y-[10px] mb-[10px]'>
                     <p className='text-[20px] font-semibold pb-[10px]'>Company</p>   
                     <a href="">Home</a>
                     <a href="">About</a>
                     <a href="">Services</a>
                     <a href="">Gallery</a>
                </div>
                <div className='font-pops text-white flex flex-col gap-y-[10px]  ml-[20px] md:ml-[0px] md:mb-[0px]  '>
                     <p className='font-semibold text-[20px] pb-[10px]'>Others</p>
                     <a href=""> Blog </a>
                     <a href=""> Contact</a>
                     <a href=""> Terms & Conditions </a>
                     <a href=""> Privacy Policy </a>
                </div>
                <div className='font-pops text-white flex flex-col mt-6 md:mt-0'>
                        <p className='font-pops font-semibold text-[20px]'>Certificate</p>
